...
Game.gui = {};
Game.state = "spiral";
Game.interfaceOrientation = {a:-1, b:-1, g:-1};
...
Game.playGame = function(time){
	...
	Game.hero.step(1, -Game.interfaceOrientation.g/4, 0, time);
...
Game.onInterfaceOrientation = function(event){
	Game.interfaceOrientation.a = event.alpha;
	Game.interfaceOrientation.b = event.beta;
	Game.interfaceOrientation.g = event.gamma;
};

Origami.initWorld(function(){
	Game.cam = Origami.cam;
	Game.gui = new GUI(Origami.ctx, Origami.world.images.text.image);
	window.addEventListener("interfaceorientation", Game.onInterfaceOrientation, false);
